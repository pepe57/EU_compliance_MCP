...
This project provides a read-only MCP server for EU regulatory reference data.
...
- Security reporting: see `/Users/jeffreyvonrotz/Projects/EU_compliance_MCP/SECURITY.md`
